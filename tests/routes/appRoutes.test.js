...
test('app registers the expected HTTP routes', () => {
  ...
  assert.deepStrictEqual(routes, [
    ...
    'GET /api/v1/open-finance/api-versions',
    'GET /api/v1/open-finance/api-versions/:id',
    ...
    'GET /api/v1/open-finance/templates/:templateId/fields',
    'GET /api/v1/open-finance/templates/:templateId/payload',
